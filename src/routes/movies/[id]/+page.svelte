	...
	<div in:slide class="flex flex-col gap-2 w-full p-4 bg-[--accent] text-sm md:text-lg">
		<div class="max-w-md">
			<div class="flex gap-2">
				<div class="font-bold w-full">Released:</div>
			...
			<div class="flex gap-2">
				<div class="font-bold w-full">IMDB:</div>
				<a
					class=" w-full"
					target="_blank"
					href={`https://www.imdb.com/title/${data.movie.imdb_id}/?ref_=fn_al_tt_1a`}>Read More</a
				>
			</div>
		</div>
	</div>
